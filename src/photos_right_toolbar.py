...
class PhotosRightToolbar(Gtk.Alignment):
    ...
    def __init__(self, images_path="", **kw):
        ...
        self._save_button = ImageTextButton(normal_path=images_path + "save_normal.png",
        ...
        self._share_button = ImageTextButton(normal_path=images_path + "share_normal.png",
        ...
        self._email_button = ImageTextButton(normal_path=images_path + "share_normal.png",
                                             hover_path=images_path + "share_hover.png",
                                             down_path=images_path + "share_down.png",
                                             label_text=_("EMAIL"),
                                             name="email-button")
